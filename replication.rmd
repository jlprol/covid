...
get_arima_results(where = "AT", j = 3, k = 4, p = 5, d = 1, q = 1)
...
atplot2<- ggplot(at_result, aes(date, fct)) +
  ...
  geom_vline(xintercept = as.Date("2020-03-16"), linetype = "dotted") +
  annotate("text", x = as.Date("2020-03-16"), y = .9, label = "(1)") +
  labs(x = element_blank(), y = element_blank(), title = "Austria") +
  mytheme() + theme(plot.title = element_text(hjust = 0.5))
...
caplot<- ggplot(ca_result, aes(date, dif)) +
  geom_ribbon(aes(date, ymin = diflow80, ymax = difup80), fill = viridis_col[8], alpha = .2) +
  geom_ribbon(aes(date, ymin = diflow95, ymax = difup95), fill = viridis_col[8], alpha = .15) +
  geom_line(color = viridis_col[8]) + geom_point(color = viridis_col[8]) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  geom_vline(xintercept = as.Date("2020-03-19"), linetype = "dotted") +
  annotate("text", x = as.Date("2020-03-19"), y = -25, label = "(1)") +
...
deplot<- ggplot(de_result, aes(date, dif)) +
  geom_ribbon(aes(date, ymin = diflow80, ymax = difup80), fill = viridis_col[6], alpha = .25) +
  geom_ribbon(aes(date, ymin = diflow95, ymax = difup95), fill = viridis_col[6], alpha = .2) +
...
deplot2<- ggplot(de_result, aes(date, fct)) +
  ...
  geom_vline(xintercept = as.Date("2020-03-22"), linetype = "dotted") +
  annotate("text", x = as.Date("2020-03-22"), y = 3, label = "(1)") +
  labs(x = element_blank(), y = element_blank(), title = "Germany") +
  mytheme() + theme(plot.title = element_text(hjust = 0.5))
...
esplot<- ggplot(es_result, aes(date, dif)) +
  geom_ribbon(aes(date, ymin = diflow80, ymax = difup80), fill = viridis_col[4], alpha = .1) +
  geom_ribbon(aes(date, ymin = diflow95, ymax = difup95), fill = viridis_col[4], alpha = .05) +
...
esplot2<- ggplot(es_result, aes(date, fct)) +
  ...
  geom_vline(xintercept = as.Date("2020-03-30"), linetype = "dotted") +
  geom_vline(xintercept = as.Date("2020-04-14"), linetype = "dotted") +
  annotate("text", x = as.Date("2020-03-15"), y = 1.33, label = "(1)") +
  annotate("text", x = as.Date("2020-03-30"), y = 1.33, label = "(2)") +
  annotate("text", x = as.Date("2020-04-14"), y = 1.33, label = "(3)") +
  labs(x = element_blank(), y = element_blank(), title = "Spain") +
  mytheme() + theme(plot.title = element_text(hjust = 0.5))
...
frplot<- ggplot(fr_result, aes(date, dif)) +
  geom_ribbon(aes(date, ymin = diflow80, ymax = difup80), fill = viridis_col[2], alpha = .1) +
  geom_ribbon(aes(date, ymin = diflow95, ymax = difup95), fill = viridis_col[2], alpha = .05) +
...
frplot2<- ggplot(fr_result, aes(date, fct)) +
  ...
  geom_vline(xintercept = as.Date("2020-03-17"), linetype = "dotted") +
  labs(x = element_blank(), y = element_blank(), title = "France") +
  annotate("text", x = as.Date("2020-03-17"), y = 2.5, label = "(1)") +
  mytheme() + theme(plot.title = element_text(hjust = 0.5))
...
gbplot<- ggplot(gb_result, aes(date, dif)) +
  geom_ribbon(aes(date, ymin = diflow80, ymax = difup80), fill = viridis_col[3], alpha = .1) +
  geom_ribbon(aes(date, ymin = diflow95, ymax = difup95), fill = viridis_col[3], alpha = .05) +
...
gbplot2<- ggplot(gb_result, aes(date, fct)) +
  ...
  geom_vline(xintercept = as.Date("2020-03-23"), linetype = "dotted") +
  labs(x = element_blank(), y = element_blank(), title = "Great Britain") +
  annotate("text", x = as.Date("2020-03-23"), y = 2, label = "(1)") +
  mytheme() + theme(plot.title = element_text(hjust = 0.5))
...
itplot<- ggplot(it_result, aes(date, dif)) +
  geom_ribbon(aes(date, ymin = diflow80, ymax = difup80), alpha = .1, fill = viridis_col[1]) +
  geom_ribbon(aes(date, ymin = diflow95, ymax = difup95), alpha = .05, fill = viridis_col[1]) +
...
itplot2<- ggplot(it_result, aes(date, fct)) +
  ...
  geom_vline(xintercept = as.Date("2020-03-21"), linetype = "dotted") +
  geom_vline(xintercept = as.Date("2020-04-14"), linetype = "dotted") +
  annotate("text", x = as.Date("2020-03-10"), y = .85, label = "(1)") +
  annotate("text", x = as.Date("2020-03-21"), y = .85,label = "(2)") +
  annotate("text", x = as.Date("2020-04-14"), y = .85, label = "(3)") +
  labs(x = element_blank(), y = element_blank(), title = "Italy") +
  mytheme() + theme(plot.title = element_text(hjust = 0.5))
...
nyplot<- ggplot(ny_result, aes(date, dif)) +
  geom_ribbon(aes(date, ymin = diflow80, ymax = difup80), fill = viridis_col[5], alpha = .25) +
  geom_ribbon(aes(date, ymin = diflow95, ymax = difup95), fill = viridis_col[5], alpha = .2) +
...
cumplot<- ggplot(cum_results, aes(t, index_pc, color = fct_reorder(country, index, .fun='last'))) +
  ...
  geom_text_repel(data = legend, aes(x = t, y = index_pc, label = country,
                               color = country, hjust = .5, vjust = -.1), fontface = "bold") +
...
```{r Stringency}
# import and clean stringency index data
stringency<- read.csv("./data/raw/stringency/OxCGRT_latest.csv") %>%
...
# change names
stringency$country<- plyr::mapvalues(stringency$country,
...
#                      AT              DE              ES              FR              GB            IT
mycolors = c(viridis_col[7], viridis_col[6],viridis_col[4], viridis_col[2], viridis_col[3], viridis_col[1])

# stringency index vs. electricity consumption plot
strindexplot<- ggplot(str_data, aes(index, dif)) +
  geom_point(aes(color = country), alpha = .2) +
  geom_hline(yintercept = 0, color = "black", linetype = "dashed") +
  geom_smooth(span = 1, se = F, color = "darkgrey", size = 1.5) +
  geom_text(data = medpoint, aes(x = index, y = dif, color = country, label = country), 
